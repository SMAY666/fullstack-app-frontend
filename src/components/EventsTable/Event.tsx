...
export default function Event({event}: Props) {
    ...
    return (
        <tr className={new Date(event.dateEnd).getTime() - Date.now() < 864000000 ? 'border-t-2 text-center bg-red-300 hover:border-2 hover:border-blue-300 hover:bg-gray-100 hover:text-black duration-300' : 'border-t-2 text-center hover:border-2 hover:border-blue-300 hover:bg-gray-100 duration-300'}>
